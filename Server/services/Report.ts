exports.Serve = function(app:any,ObjectID:any,MongoClient:any,connection:any,passwordHash:any) {
    app.post('/api/report/members', function(request:any, response:any) {
    try {
        var dfn : ReportDefinition = new ReportDefinition();
    ...
    function printreport(definition:ReportDefinition) {
    ...
    //   };
      ...
      var rpt = new Report(definition.Path)//, {margins: {left:20, top:20, right: 20, bottom:20}})
        ...
        var nameheader = function (report: any, data: any) {
            report.print(data.name, { fontBold: true, underline: true });
        };
        var weekdetail = function (report: any, data: any) {
        ...
        var namefooter = function (report: any, data: any, state: any) {
    ...
    //    rpt.printStructure(true);
      rpt.render(function(err:any, name:any) { });
